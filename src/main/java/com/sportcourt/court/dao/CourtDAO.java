...
public interface CourtDAO {
    ...
    Optional<Court> findByInBranch(String courtId, String branchId) throws SQLException;
    boolean isExistedById(String courtId) throws SQLException;
    boolean isAreaBelongToBranch(String  AreaId, String branchId) throws SQLException;
    boolean isRental(String courtId, String branchId) throws SQLException;
