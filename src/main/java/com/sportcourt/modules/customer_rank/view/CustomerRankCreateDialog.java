...
final class CustomerRankCreateDialog {
    ...
    static void show(Component parent) {
        ...
        addField(form, g, 0, "Mã hạng", txtMaHang);
        addField(form, g, 1, "Tên hạng", txtTenHang);
        addField(form, g, 2, "Chiết khấu (%)", txtChietKhau);
        addField(form, g, 3, "Mức tiền (VNĐ)", txtMucTien);
        root.add(form, BorderLayout.CENTER);

        JPanel actions = new JPanel(new GridLayout(1, 2, 10, 0));
        actions.setOpaque(false);
        JButton btnCancel = button("Hủy", BUTTON_MUTED, TEXT_DARK);
        JButton btnSave = button("Thêm hạng", BRAND_GREEN, Color.WHITE);
        ...
        btnSave.addActionListener(e -> {
            ...
            try {
                ...
                System.out.println("[CustomerRank Create] Mã: " + maHang + ", Tên: " + tenHang
                        + ", Chiết khấu: " + chietKhau + "%, Mức tiền: " + mucTien);
