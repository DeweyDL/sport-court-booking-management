...
final class CustomerRankEditDialog {
    ...
    static void show(Component parent, CustomerRankItem item) {
        ...
        JLabel title = new JLabel("Chỉnh sửa hạng khách hàng");
        ...
        addField(form, g, 0, "Tên hạng", txtTenHang);
        addField(form, g, 1, "Chiết khấu (%)", txtChietKhau);
        addField(form, g, 2, "Mức tiền (VNĐ)", txtMucTien);
        ...
        btnSave.addActionListener(e -> {
            ...
            try {
                ...
                System.out.println("[CustomerRank Edit] Mã: " + item.maHang() + ", Tên: " + tenHang
