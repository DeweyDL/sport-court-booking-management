...
final class BranchChange {
    ...
    private BranchChange() {
    }

    static BranchUpdateRequest show(Component parent, Branch branch) {
        Window owner = parent == null ? null : SwingUtilities.getWindowAncestor(parent);
        JDialog dialog = new JDialog(owner, "Cập nhật chi nhánh", Dialog.ModalityType.APPLICATION_MODAL);
        ...
        JLabel title = new JLabel("Cập nhật chi nhánh");
        title.setFont(AppFonts.lexendBold(24f));
        title.setForeground(TEXT_DARK);
        JLabel subtitle = new JLabel("Chỉnh sửa các thông tin cơ bản của chi nhánh.");
        ...
        JTextField maCnField = readonly(branch.maCn());
        JTextField tenChiNhanhField = new JTextField(branch.tenChiNhanh());
        JTextField diaChiField = new JTextField(branch.diaChi());
        JTextField hotlineField = new JTextField(branch.hotline() == null ? "" : branch.hotline());
        ...
        final BranchUpdateRequest[] result = new BranchUpdateRequest[1];
        ...
        btnSave.addActionListener(e -> {
            ...
            result[0] = new BranchUpdateRequest(branch.maCn(), ten, diaChi, hotline.isEmpty() ? null : hotline);
            dialog.dispose();
        });
