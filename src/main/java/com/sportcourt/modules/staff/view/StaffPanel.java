...
public class StaffPanel extends JPanel {
    ...
    public void setLoading(boolean loading) {
        ...
        footerLabel.setText(loading ? "Đang tải dữ liệu..." : "Đang hiển thị " + tableModel.getRowCount() + " nhân viên");
    }
    ...
    private void setupTable() {
        ...
        table.getColumnModel().getColumn(StaffTableModel.COL_ACTION).setPreferredWidth(180);
    ...
    private JButton createAddButton() {
        JButton button = new JButton("+ Thêm nhân viên");
    ...
    private class RoleCellRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            ...
            boolean isManager = "QUẢN LÝ".equalsIgnoreCase(text);
            ...
            wrapper.add(createPill(text, isManager ? GREEN : TEXT, isManager ? GREEN_LIGHT : new Color(241, 245, 249)));
            return wrapper;
        }
    }
    ...
    private class StatusCellRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            ...
            wrapper.setBackground(isSelected ? table.getSelectionBackground() : Color.WHITE);
            wrapper.setBorder(BorderFactory.createMatteBorder(0, 0, 1, 1, BORDER));
            wrapper.add(createPill("• " + String.valueOf(value), GREEN, GREEN_LIGHT));
            return wrapper;
        }
    }
    ...
    private class ActionCellRenderer extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            ...
            panel.add(createActionPill("Xóa", RED, RED_LIGHT));
            panel.add(createActionPill("Chỉnh sửa", BLUE, BLUE_LIGHT));
            return panel;
        }
    }

    private JLabel createPill(String text, Color foreground, Color background) {
    ...
    private JLabel createActionPill(String text, Color foreground, Color background) {
        JLabel label = createPill(text, foreground, background);
