...
public class UserProfileEditPabel extends JPanel implements Scrollable {
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            JScrollPane scrollPane = new JScrollPane(new UserProfileEditPabel());
