...
public class AreaAdd extends JPanel {
    ...
    public AreaAdd(KhuVucController khuVucController, Consumer<String> onSaved) {
    ...
    private void prepareCreateForm() {
        generatedMaKv = khuVucController.generateNextMaKv();
        maKvField.setText(generatedMaKv);
        maCnField.setText(khuVucController.getDefaultChiNhanhId());
    ...
    private void saveNewKhuVuc() {
        ...
        KhuVucCreateRequest request = new KhuVucCreateRequest(
                generatedMaKv,
                khuVucController.getDefaultChiNhanhId(),
